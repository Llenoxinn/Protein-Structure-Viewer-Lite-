export default function AtomTooltip({ atom }) {
  ...
  return (
    <div
      className="fixed bottom-4 right-4 z-50 max-w-[180px] rounded border border-white/10 bg-[#1a1a1e] p-3 font-mono text-[11px] leading-relaxed shadow-lg transition-opacity duration-200 opacity-100"
    >
